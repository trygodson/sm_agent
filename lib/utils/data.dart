...
List community = [
  {
    ...
    'name': 'Jonathan',
    'title': 'A 103 owner, 2hrs ago',
    'detail': 'bamboo grooves near the clubhouse'
  },
  {
    'image': "https://avatars.githubusercontent.com/u/86506519?v=4",
    'name': 'Jonathan',
...
List quickMenus = [
  {"name": "Pay Bills", "icon": FontAwesomeIcons.userFriends},
  {"name": "List Properties", "icon": FontAwesomeIcons.search},
  {"name": "Shop", "Connect With Neighbors": FontAwesomeIcons.storeAlt},
  {"name": "Building", "icon": FontAwesomeIcons.building},
  {"name": "House", "icon": FontAwesomeIcons.home},
];
List otherMenus = [
  ...
  {
    "name": "Pay bills",
    "Connect With Neighbors": FontAwesomeIcons.store,
    'color': primary,
    'page': () => null
  },
  {
